...
class SearchEngineControllerse_keywordgroup extends SearchEngineController {
    ...
    function add() {	   
        ...
        $link = 'index.php?option=com_searchengine&view=se_keywordgroup&layout=create&package_id='.JRequest::getVar('package_id');
        $app->redirect($link);	   
    }
    ...
    function save(){ 
        ...
        $this->setRedirect('index.php?option=com_searchengine&view=se_keywordgroup&package_id='.JRequest::getVar('package_id'), $msg);		
    }
