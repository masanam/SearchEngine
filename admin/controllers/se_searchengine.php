...
class SearchEngineControllerse_Searchengine extends JControllerLegacy {
	...
	function search(){
		...
		$msg = "";
		$this->setRedirect("index.php?option=com_searchengine&Itemid=".JRequest::getVar('Itemid')."&search=".JRequest::getVar('keyword')."&uid=".$data['uniqueid']."&type=".$search_type, $msg);
