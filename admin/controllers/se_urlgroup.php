...
class SearchEngineControllerse_urlgroup extends SearchEngineController {
    ...
    function add() {	   
        ...
        $link = 'index.php?option=com_searchengine&view=se_urlgroup&layout=create&package_id='.JRequest::getVar('package_id');
        $app->redirect($link);	   
    }
    ...
    function save(){ 
        ...
        $this->setRedirect('index.php?option=com_searchengine&view=se_urlgroup&package_id='.JRequest::getVar('package_id'), $msg);		
    }
