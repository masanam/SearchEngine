...
class SearchEngineModelQuizs extends JModelLegacy {
	...
	public function get_quizs($ids = array(), $limit = 20, $limitstart = 0, $published = -1){
		$user = JFactory::getUser();
		$app = JFactory::getApplication();

		$filter_order = $app->getUserStateFromRequest( S_APP_NAME.'.quizs.filter_order', 'filter_order', 'a.created', 'cmd' );
		$filter_order_dir = $app->getUserStateFromRequest( S_APP_NAME.'.quizs.filter_order_dir', 'filter_order_Dir', 'DESC', 'word' );
