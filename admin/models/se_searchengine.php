...
class SearchEngineModelse_SearchEngine extends JModelLegacy{
		...
		return $result;
			...
			public function getSearchListTotal($limitstart,$limit){
		$this->_db = &JFactory::getDBO();
		$query = "SELECT * FROM #__se_search_list limit $limitstart,$limit " ;
		$this->_db->setQuery ( $query );
		$result = $this->_db->loadObjectList();
		return $result;
			}
