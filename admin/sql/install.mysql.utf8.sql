...
-- Dumping structure for table joomlatest.#__se_search_result_detail
DROP TABLE IF EXISTS `#__se_search_result_detail`;
CREATE TABLE `#__se_search_result_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `list_id` varchar(50) DEFAULT NULL,
  `search_title` varchar(1000) DEFAULT NULL,
  `search_description` varchar(1000) DEFAULT NULL,
  `search_meta_description` varchar(1000) DEFAULT NULL,
  `search_link` varchar(50) DEFAULT NULL,
  `search_image_thumb` varchar(1000) DEFAULT NULL,
  `search_type` varchar(1000) DEFAULT NULL,
  `search_keyword` varchar(1000) DEFAULT NULL,
  `created_at` datetime NOT NULL,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping structure for table joomlatest.#__se_user_search_list
DROP TABLE IF EXISTS `#__se_user_search_list`;
CREATE TABLE IF NOT EXISTS `#__se_user_search_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `search_type` varchar(30) NOT NULL,
  `search_keyword` varchar(150) NOT NULL,
  `userip_addr` varchar(100) NOT NULL,
  `user_id` int(11) NOT NULL,
  `package_id` int(20) NOT NULL DEFAULT '0',
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table joomlatest.#__check
DROP TABLE IF EXISTS `#__check`;
CREATE TABLE IF NOT EXISTS `#__check` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `check_status` varchar(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `#__check` (`id`, `check_status`) VALUES ('1', '0');
-- Dumping data for table `fbolc_check`
--
