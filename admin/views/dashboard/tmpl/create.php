					...
					<div class="selection">
                        ...
                        <div class="span10 tab1 tabsdata" id="tab_rewards_profile">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="padding-left: 20px;"><?php echo JText::_('Reward Name');?></td>        
                                    <td>
                                        <div style="width: 20px;"></div>                        
                                    </td>
                                    <td><input type="text" id="reward_name" name="reward_name" value="" class="required" data-rule-required="true" data-msg-required="This field is required" onkeypress=""/></td>
                                </tr> 
                                ...
                                <tr>
									...
									<input type="date" id="publish_start_date" name="publish_start_date" value="" data-rule-required="true" data-msg-required="This field is required" class="required" onkeypress=""/>
									</td>
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    <td><input type="date" id="publish_end_date" name="publish_end_date" value="" data-rule-required="true" data-msg-required="This field is required" class="required" onkeypress=""/></td>
                                </tr> 
									<script>
                                ...
                                <tr>
                                    ...
                                    <td><textarea id="sedescription" name="sedescription" value="" class="required" onkeypress=""/></textarea></td>
                                </tr> 
						...
						<div class="span10 tab2 tabsdata" id="tab_search_engine_user_group" style="display:none;">
							...
							<br><br>
							Description<br><textarea id="seugdesc" name="seugdesc"></textarea>
						</div>
						<div class="span10 tab3 tabsdata" id="tab_keyword_group" style="display:none;">
							...
							<br><br>
							Description<br><textarea id="kgdesc" name="kgdesc"></textarea>
						</div>
						<div class="span10 tab4 tabsdata" id="tab_url_group" style="display:none;">
							...
							<br><br>
							Description<br><textarea id="ugdesc" name="ugdesc"></textarea>
						</div>
						<div class="span10 tab5 tabsdata" id="tab_survey_group" style="display:none;">
							...
							<br><br>
							Description<br><textarea id="sgdesc" name="sgdesc"></textarea>
						</div>
						<div class="span10 tab6 tabsdata" id="tab_quiz_group" style="display:none;">
							...
							<br><br>
							Description<br><textarea id="qgdesc" name="qgdesc"></textarea>
						</div>
...
?>
								<tr class="modaltrseug" class="row<?php echo $i%2;?>">
									...
									<td align="center"><?php echo strtotime($seuglist->created)>0 ? date('G:i a d M Y',strtotime($seuglist->created)): '-';?></td>
								</tr>
								<?php } ?>
							</tbody>							
						</table>
						...
						<table class="table table-striped">
							...
							<?php foreach ($this->kglist as $i=>$kglist) { ?>
								<tr class="modaltrkg" class="row<?php echo $i%2;?>">
									...
									<td align="center"><?php echo strtotime($kglist->created)>0 ? date('G:i a d M Y',strtotime($kglist->created)): '-';?></td>
						...
						<table class="table table-striped">
							...
							<?php foreach ($this->uglist as $i=>$uglist) { ?>
								<tr class="modaltrug" class="row<?php echo $i%2;?>">
									...
									<td align="center"><?php echo strtotime($uglist->created)>0 ? date('G:i a d M Y',strtotime($uglist->created)): '-';?></td>
						...
						<table class="table table-striped">
							...
							<?php foreach ($this->sglist as $i=>$sglist) { ?>
								<tr class="modaltrsg" class="row<?php echo $i%2;?>">
									...
									<td align="center"><?php echo strtotime($sglist->created)>0 ? date('G:i a d M Y',strtotime($sglist->created)): '-';?></td>
						...
						<table class="table table-striped">
							...
							<?php foreach ($this->qglist as $i=>$qglist) { ?>
								<tr class="modaltrqg" class="row<?php echo $i%2;?>">
									...
									<td align="center"><?php echo strtotime($qglist->created)>0 ? date('G:i a d M Y',strtotime($qglist->created)): '-';?></td>
