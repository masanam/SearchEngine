    ...
    <div class="survey-wrapper nospace-left no-space-left no-space-right">
        <div class="row-fluid">
            ...
            <div id="j-main-container" class="span10">
                <form action="index.php?option=com_searcengine&view=se_dashboard&task=se_dashboard.save" method="post" name="adminForm" class="form-validate" id="adminForm">
                    <div id="wrapper">
                        ...
                        <div class="span10 tab1 tabsdata" id="tab_rewards_profile">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="reward_name" name="reward_name" value="<?php if(!empty($this->serl_details[0]->title)) echo $this->serl_details[0]->title;?>" class="required" onkeypress=""/></td>
                                </tr> 
                                ...
                                <tr>
									...
									<input type="date" id="publish_start_date" name="publish_start_date" value="<?php if(!empty($this->serl_details[0]->startpublishdate)) echo $this->serl_details[0]->startpublishdate;?>" class="required" onkeypress=""/>
									</td>
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    <td><input type="date" id="publish_end_date" name="publish_end_date" value="<?php if(!empty($this->serl_details[0]->endpublishdate)) echo $this->serl_details[0]->endpublishdate;?>" class="required" onkeypress=""/></td>
                                </tr> 
									<script>
