...
<table align="center" border="0" class="table table-hover table-striped">
        <thead>
            ...
            <tr class="row<?php echo $k % 2; ?>">
                ...
                <td>
				<a href="<?php echo JRoute::_('index.php?option=com_searchengine&controller=se_keywordgroup&task=edit&cid='.$result->id.'&package_id='.JRequest::getVar('package_id')); ?>"><?php echo $result->title; ?>
				</a>
