    ...
    <table align="center" border="0" class="table table-hover table-striped">
        <thead>
            ...
            <tr style="text-align:center;">
                ...
                <td>
				<a href="<?php echo JRoute::_('index.php?option=com_searchengine&controller=se_quizgroup&task=edit&cid='.$result->id.'&package_id='.JRequest::getVar('package_id')); ?>"><?php echo $result->title; ?>
				</a>
