...
class SearchEngineViewse_urlgroup extends JViewLegacy {
    ...
    {
        JToolBarHelper::title('Url group list');	
        ...
        $model = $this->getModel();
        $listModel = JModelLegacy::getInstance('se_keywordgroup','SearchEngineModel');
    ...
    function addStyleSheet(){
     ...
     function create(){
        ...
        JToolBarHelper::save();
        JToolbarHelper::back('Cancel', 'index.php?option=com_searchengine&view=se_urlgroup&package_id='.JRequest::getVar('package_id'));
		
		$cid = JRequest::getVar('cid');
		
		if ( $cid != '' ) {
			JToolBarHelper::title(JText::_('Edit url group'),'generic.png');
			$is_edit = true;
		  } else {
			JToolBarHelper::title(JText::_('Create url group'),'generic.png');
		  }
