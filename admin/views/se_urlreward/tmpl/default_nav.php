    ...
    <div id="sidebar">
        <div class="sidebar-nav">
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li>
                    <a href="<?php echo JRoute::_('index.php?option=com_searchengine&view=se_usergroup&task=se_usergroup.getlist&package_id='.JRequest::getVar('package_id'), false);?>">Search engine user group list</a>
                </li>
                <li <?php if($this->active==''){?> class="active" <?php }?>>
                ...
                <li class="active">
                    <a href="<?php echo JRoute::_('index.php?option=com_searchengine&view=se_urlreward&task=se_urlreward.getlist&package_id='.JRequest::getVar('package_id'), false);?>">Url rewards list</a>
                </li>
                <li <?php if($this->active==''){?> class="active" <?php }?>>
