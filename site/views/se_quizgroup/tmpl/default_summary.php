	...
	<div class="navbar-inner" style="background-color: #fafafa;">	
		<div class="header-container">
			<div class="cq-nav-collapse nav-collapse collapse">
				<ul class="nav">					
					<li>
						<a class="btn" href="<?php echo JRoute::_('index.php?option=com_searchengine&view=se_quizgroup&layout=create');?>">
							<?php echo JText::_('New quiz group');?>														
						</a>						
					</li>
					<li>
    ...
    <table align="center" border="0" class="table table-hover table-striped">
        <thead>
            ...
            <tr style="text-align:center;">
                ...
                <td>
				<a href="<?php echo JRoute::_('index.php?option=com_searchengine&controller=se_quizgroup&task=edit&cid='.$result->id); ?>"><?php echo $result->title; ?>
				</a>
