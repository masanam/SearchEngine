		...
		<div class="header-container">
			<div class="cq-nav-collapse nav-collapse collapse">
				<ul class="nav">					
					...
					<li>
						<a href="<?php echo JRoute::_('index.php?option=com_searchengine&view=se_urlgroup');?>">
                        ...
                        <div class="tabsContent"> 
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text" id="survey_group_name" name="url_group_name" value="<?php echo $urlgroup_title;?>" class="required" data-rule-required="true" data-msg-required="This field is required" onkeypress=""/></td>
                                </tr>  
                            </table>
...
<tbody id="tblurls">
                                ...
                                <tr id="tr<?php echo $i; ?>">
                                    ...
                                    <td style="padding: 10px;text-align:center;">
                                        <div class="serialnumber" style="width: 20px;">1</div>                        
                                    </td>
