...
Joomla.submitbutton = function(pressbutton) {
	if(pressbutton=='se_urlreward.create'){
		window.location.href = "index.php?option=com_searchengine&controller=se_urlreward&task=create";
	}else{
...
<form method="post" action="<?php echo JRoute::_('index.php?option=com_searchengine&controller=se_urlreward&task=se_urlreward.delete');?>" name="adminForm" id="adminForm">
<div class="navbar">
	<div class="navbar-inner" style="background-color: #fafafa;">	
		<div class="header-container">
			<div class="cq-nav-collapse nav-collapse collapse">
				<ul class="nav">					
					<li>
						<a class="btn" href="<?php echo JRoute::_('index.php?option=com_searchengine&view=se_urlreward&task=create');?>">
							<?php echo JText::_('New url reward');?>														
						</a>							
					</li>
					<li>
...
<table align="center" border="0" class="table table-hover table-striped">
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td align="center"><a href="<?php echo JRoute::_('index.php?option=com_searchengine&view=se_urlreward&task=se_urlreward.edit&id='.$result->id); ?>"><?php echo $result->title;?></td>
