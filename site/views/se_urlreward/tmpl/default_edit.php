	...
	<div class="navbar-inner" style="background-color: #fafafa;">	
		...
		<div>
				...
				<div class="span10">					
					...
					<div class="span10">
						<input type="text" name="title" id="title" data-rule-required="true" data-msg-required="This field is required" value="<?php if(!empty($this->rule_details[0]->title)) echo $this->rule_details[0]->title;?>" >
					</div>
				</div><br><br>
