...
<div id="cj-wrapper">
  <div class="container-fluid quiz-wrapper nospace-left no-space-left no-space-right">
	...
	<div class="span10">
  <div class="clearfix">
    <form action="index.php?option=com_searchengine&controller=se_usergroup&task=se_usergroup.save" method="post" name="adminForm" id="adminForm" class="form-validate">
		...
		<div class="header-container">
			<div class="cq-nav-collapse nav-collapse collapse">
				<ul class="nav">					
					...
					<li>
						<a href="<?php echo JRoute::_('index.php?option=com_searchengine&view=se_usergroup');?>">
...
Joomla.submitbutton = function(pressbutton) {
  if(pressbutton=='se_usergroup.back'){
    window.location.href = "index.php?option=com_searchengine&views=se_usergroup&task=se_usergroup.getlist";
  }else{
